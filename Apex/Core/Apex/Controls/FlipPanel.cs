...
namespace Apex.Controls
{
    ...
    public class FlipPanel : Control
    {
        ...
        /// </summary>
        public static readonly DependencyProperty ContentFrontProperty =
            DependencyProperty.Register("ContentFront", typeof(object), typeof(FlipPanel));

        /// <summary>
        /// The ContentBack dependency property.
        /// </summary>
        public static readonly DependencyProperty ContentBackProperty =
            DependencyProperty.Register("ContentBack", typeof(object), typeof(FlipPanel));

        /// <summary>
        /// The AspectRatio dependency property.
        /// </summary>
        public static readonly DependencyProperty AspectRatioProperty =
            DependencyProperty.Register("AspectRatio", typeof(double), typeof(FlipPanel), new PropertyMetadata(0.5));
        ...
        /// </summary>
        public static readonly RoutedEvent FlippedFrontToBackEvent =
            EventManager.RegisterRoutedEvent("FlippedFrontToBack", RoutingStrategy.Bubble, typeof(RoutedEventHandler),
                typeof(FlipPanel));

        /// <summary>
        /// Occurs when flipped back to front.
        /// </summary>
        public static readonly RoutedEvent FlippedBackToFrontEvent =
            EventManager.RegisterRoutedEvent("FlippedBackToFront", RoutingStrategy.Bubble, typeof(RoutedEventHandler),
                typeof(FlipPanel));
